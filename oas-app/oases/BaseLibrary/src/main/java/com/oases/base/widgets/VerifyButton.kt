...
class VerifyButton(mContext: Context, attrs: AttributeSet) : Button(mContext, attrs) {
    ...
    private val countDown = object : Runnable {
        override fun run() {
            ...
            //this@VerifyButton.setBackgroundColor(resources.getColor(R.color.common_disable, Resources.Theme.))
    ...
    fun resetCounter(vararg text: String) {
        ...
        //this.setBackgroundColor(resources.getColor(R.color.transparent, resources.getTheme()))
        //this.setTextColor(resources.getColor(context, R.color.common_blue))
        mCount = 60
    }
