...
data class MinerHistoryItem(val minerName:String,val minerStatus:Int,val minerNum:Int,val created:String,val minerEndTime:String,val minerPrice:BigDecimal,val minerPower:BigDecimal,val period:Int)
