...
data class ComputingPowerItem(val activity:String?, val created:String,val value:BigDecimal,val powerChange:BigDecimal,val category:String?,val inOrOut:Int)
