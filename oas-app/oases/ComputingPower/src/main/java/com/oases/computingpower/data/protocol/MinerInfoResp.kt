...
data class MinerInfoItem(val minerName:String,val minerPrice:BigDecimal,val minerPower:BigDecimal,val minerPeriod:Int,val minerMaxOutput:BigDecimal,val minerGrade:Int,val orderNum:Int)
