...
function authorMinnerSolo(abs,id){
	if(abs==2){
		var row=$("#testGrid").bootstrapTable('getRowByUniqueId',id);
		
	}else if(abs==1){
		 row=$("#normalGrid").bootstrapTable('getRowByUniqueId',id);
