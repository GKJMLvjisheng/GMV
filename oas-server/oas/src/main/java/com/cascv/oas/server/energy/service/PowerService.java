 ...
 */
    ...
    public List<EnergyPowerChangeDetail> searchEnergyPowerChange(String userUuid, Integer offset, Integer limit){
    	...
    	for(EnergyPowerChangeDetail energyPowerChangeDetail : energyPowerChangeDetailList) {
    		...
    		if(energyPowerChangeDetail.getSourceCode() != null &&energyPowerChangeDetail.getSourceCode() == 11 && energyPowerChangeDetail.getInOrOut() == 1) {
    			energyPowerChangeDetail.setActivity("矿机推广奖励");
    		}
    		if(energyPowerChangeDetail.getSourceCode() != null &&energyPowerChangeDetail.getSourceCode() == 11 && energyPowerChangeDetail.getInOrOut() == 0) {
